...
Here we have included the 2-gram combination of words with TfidfVectorizer as it was giving 
...
def run(fold):
    ...
    tfv_bigram = TfidfVectorizer(
        tokenizer=word_tokenize,
        token_pattern=None,
        ngram_range=(1, 2)   # this parameter offers bi-gram 
    )

    tfv_bigram.fit(df_train.review)

    x_train = tfv_bigram.transform(df_train.review)

    x_valid = tfv_bigram.transform(df_valid.review)
